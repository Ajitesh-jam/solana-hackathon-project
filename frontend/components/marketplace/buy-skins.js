...
const mockMarketplaceListings = [
  {
    ...
    skinId: "skin-001",
    sellerName: "CryptoGamer",
    sellerWalletAddress: "7yG3Zp1L8sB6Vj8...",
    price: 230,
    listedDate: "2023-04-28",
  },
  {
    listingId: "listing-002",
    skinId: "skin-002",
    sellerName: "SolanaKing",
    sellerWalletAddress: "5xT7Kp2L9sB6Vj8...",
    price: 160,
    listedDate: "2023-04-27",
  },
  {
    listingId: "listing-003",
    skinId: "skin-003",
    sellerName: "BlockchainNinja",
    sellerWalletAddress: "2xR7Kp2L9sB6Vj8...",
    price: 200,
    listedDate: "2023-04-26",
  },
  {
    listingId: "listing-004",
    skinId: "skin-001",
    sellerName: "GameMaster",
    sellerWalletAddress: "4xT7Kp2L9sB6Vj8...",
    price: 240,
...
export default function BuySkins() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // const response = await fetch('/api/marketplace/skins')
  ...
  const handleBuyMarketplaceSkin = (listing, skin) => {
    if (!user) {
      toast({
        title: "Authentication Required",
        description: "Please login to purchase skins",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white p-4 md:p-8">
      ...
      >
        ...
        <p className="text-gray-300">Browse and purchase exclusive skins for your favorite games</p>
      </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Purchase skins directly from game companies. These are brand new skins that have never been owned
                    before.
                  </p>
                </div>
              </motion.div>
          ...
          <TabsContent value="marketplace">
            ...
            >
              ...
              >
                ...
                <div>
                  <h3 className="font-medium text-purple-400">Player Marketplace</h3>
                  <p className="text-sm text-gray-300">
                    Buy skins from other players, often at discounted prices. When you purchase from the marketplace,
                    10% of the sale goes to the game company and 90% to the seller.
                  </p>
                </div>
              </motion.div>
              ...
              {filteredMarketplaceListings.length === 0 ? (
                ...
                >
                  <ShoppingCart className="h-16 w-16 mx-auto text-gray-600 mb-4" />
                  <h3 className="text-xl font-medium mb-2">No marketplace listings found</h3>
                  <p className="text-gray-400">Try adjusting your filters or search query</p>
                </motion.div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
